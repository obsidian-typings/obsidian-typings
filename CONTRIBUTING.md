...
```js
generateTypes = (await requireAsync('https://raw.githubusercontent.com/obsidian-typings/obsidian-typings/refs/heads/main/tools/generateTypes.ts', { moduleType: 'jsTs' })).generateTypes;
```
