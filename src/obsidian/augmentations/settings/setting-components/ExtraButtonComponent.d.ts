import type { getExtraButtonComponentConstructor } from '../../../implementations/constructors/augmentations/settings/setting-components/getExtraButtonComponentConstructor.d.ts';
