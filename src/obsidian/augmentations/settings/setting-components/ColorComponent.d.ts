import type { getColorComponentConstructor } from '../../../implementations/constructors/augmentations/settings/setting-components/getColorComponentConstructor.d.ts';
