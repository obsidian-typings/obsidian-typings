import type { getSearchComponentConstructor } from '../../../implementations/constructors/augmentations/settings/setting-components/getSearchComponentConstructor.d.ts';
