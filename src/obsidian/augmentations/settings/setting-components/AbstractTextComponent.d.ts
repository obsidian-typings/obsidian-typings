import type { getAbstractTextComponentConstructor } from '../../../implementations/constructors/augmentations/settings/setting-components/getAbstractTextComponentConstructor.d.ts';
...
declare module 'obsidian' {
  ...
  interface AbstractTextComponent<T extends HTMLInputElement | HTMLTextAreaElement> extends ValueComponent<string> {
    ...
    /**
     * Manually invokes the callback registered with {@link onChange}.
     *
     * @official
     * @since 0.9.21
     */
