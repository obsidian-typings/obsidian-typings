import type { getMomentFormatComponentConstructor } from '../../../implementations/constructors/augmentations/settings/setting-components/getMomentFormatComponentConstructor.d.ts';
