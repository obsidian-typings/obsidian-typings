import type { getToggleComponentConstructor } from '../../../implementations/constructors/augmentations/settings/setting-components/getToggleComponentConstructor.d.ts';
