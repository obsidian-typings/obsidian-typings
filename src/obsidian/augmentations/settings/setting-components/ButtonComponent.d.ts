import type { getButtonComponentConstructor } from '../../../implementations/constructors/augmentations/settings/setting-components/getButtonComponentConstructor.d.ts';
