import type { getProgressBarComponentConstructor } from '../../../implementations/constructors/augmentations/settings/setting-components/getProgressBarComponentConstructor.d.ts';
