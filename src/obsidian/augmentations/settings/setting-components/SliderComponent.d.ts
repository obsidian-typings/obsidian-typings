import type { getSliderComponentConstructor } from '../../../implementations/constructors/augmentations/settings/setting-components/getSliderComponentConstructor.d.ts';
