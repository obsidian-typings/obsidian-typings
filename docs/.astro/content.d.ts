...
declare module 'astro:content' {
  ...
  ): E extends ValidContentEntrySlug<C> ? Promise<CollectionEntry<C>>
  ...
  ): E extends keyof DataEntryMap[C] ? Promise<DataEntryMap[C][E]>
    : Promise<CollectionEntry<C> | undefined>;
  export function getEntry<
    C extends keyof ContentEntryMap,
    E extends ({} & string) | ValidContentEntrySlug<C>
  ...
  >(
    collection: C,
    id: E
  ): E extends keyof DataEntryMap[C] ? string extends keyof DataEntryMap[C] ? Promise<DataEntryMap[C][E]> | undefined
  ...
  export function reference<C extends keyof AnyEntryMap>(
    ...
    C extends keyof ContentEntryMap ? ReferenceContentEntry<C, ValidContentEntrySlug<C>>
