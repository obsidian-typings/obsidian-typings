...
const ICON_STYLE = `width: ${ICON_SIZE}px !important; height: ${ICON_SIZE}px !important; min-width: ${ICON_SIZE}px; min-height: ${ICON_SIZE}px; vertical-align: middle; display: inline-block`;
