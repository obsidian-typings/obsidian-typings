...
Additional helper functions/types/... added by this package, can be added by importing from the `/implementations` subpath:
...
(The list of all available implementations can be found in the [implementations](https://github.com/obsidian-typings/obsidian-typings/tree/main/src/implementations) folder.)
